...
const Book = () => {
  ...
  const [replay1, setReplay1] = useState<any>();

  const [data, setData] = useState<any>();
  const state = useSelector((state: any) => state.login);
  const [id, setId] = useState<any>(location.state.Api);
        ...
        <div className="lg:flex lg:justify-between bg-indigo-100 rounded-lg lg:w-2/3 relative">
          <div className="lg:p-6 p-4">
            ...
            <p>
              ...
              repudiandae ducimus incidunt minus molestiae consequuntur corporis
              delectus, ipsam, voluptas blanditiis.
            </p>
          </div>
